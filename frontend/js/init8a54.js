      ...
      frenifyChat: function () {
        ...
        var n = {
          welcome: {
            ...
            text: "<p>AyurvediCure is a Beautiful website</p>",
            append: !0,
          },
          about: {
            type: "text",
          ...
          support: {
            type: "url",
            description:
              "if you have any questions regarding AyurvediCure feel free and contact us by this command",
            append: !1,
            url: "#",
          },
          youtube: {
        ...
        var l =
          "<p>Hello.</p><p>I am AyurvediCure AI Bot. After signing up, you can do something-something. I understand some commands. You just select one of the commands and write here.</p><p>Here is the list of commands:</p>" +
          (o += "</ul>") +
          "<p></p>";
        n.welcome.text = l;
        var h = [
        ...
        c &&
          (t =
            '<p>I only understand some commands. Of course, this is a fixable problem. Edit and implement AI and that\'s it.'),
          a &&
            (e(".fn__chat_comment button").addClass("disabled"),
            setTimeout(function () {
              e(".fn__chatbot .chat__item.active").append(
                '<div class="chat__box bot__chat"><div class="author"><span>AyurvediCure Bot</span></div><div class="chat"><frenify_typing><h3><span>Typing...</frenify></h3></div></div>'
              ),
                e(".techwave_fn_intro").length
                  ? e("html, body").animate({
                      scrollTop:
